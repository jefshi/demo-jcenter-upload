...
//    }
     ...
     */
    public static void e(String explain, Object... message) {
        if (message != null && message.length == 1 && !explain.contains("%s"))
            log(Log.ERROR, DEFAULT_STACK_ID, explain, message[0]);
        else
            log(Log.ERROR, DEFAULT_STACK_ID, null, String.format(explain, message));
    }
    ...
    public static void i(String explain, Object... message) {
        if (message != null && message.length == 1 && !explain.contains("%s"))
            log(Log.INFO, DEFAULT_STACK_ID, explain, message[0]);
        else
            log(Log.INFO, DEFAULT_STACK_ID, null, String.format(explain, message));
    }
